...
<script src="//cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script> -->
   ...
   <body>
     <div  align="center" color="white" >
       <font color="white">
  <br> <br>   <h1 style="font-size: 3em"> برنامج تسجيل الأحكام</h1>
   </font>
   </div>
     <div id="home_quicklinks">
                                <a class="quicklink link1" href="register.php">
                                    <span class="ql_caption">
                                        <span class="outer">
                                            <span class="inner">
                                                <h2 style="font-size: 40px">ادخال احكام</h2>
                                            </span>
                                        </span>
                                    </span>
                                ...
                                <a class="quicklink link3" href="show.php">
                                    <span class="ql_caption">
                                        <span class="outer">
                                            <span class="inner">
                                                <h2 style="font-size: 40px">تقرير احكام </h2>
                                            </span>
                                        </span>
                                    </span>
                                    <span class="ql_top"></span>
